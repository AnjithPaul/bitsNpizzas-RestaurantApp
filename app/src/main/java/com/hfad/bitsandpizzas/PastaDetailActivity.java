...
public class PastaDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView= (TextView)findViewById(R.id.pasta_head);
        ...
        String pizzaDetails=Pasta.pastas[pastaId].getDetails();
        TextView textBody=(TextView)findViewById(R.id.pasta_body);
