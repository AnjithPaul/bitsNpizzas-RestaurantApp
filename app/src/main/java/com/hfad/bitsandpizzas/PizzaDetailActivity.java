...
public class PizzaDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textHead = (TextView)findViewById(R.id.pizza_head);
        textHead.setText(pizzaName);
        ...
        String pizzaDetails=Pizza.pizzas[pizzaId].getDetails();
        TextView textBody=(TextView)findViewById(R.id.pizza_body);
        textBody.setText(pizzaDetails);
    }
}
